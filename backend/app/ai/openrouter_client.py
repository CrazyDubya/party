    ...
    async def generate_story(
        ...
        try:
            ...
            story_data["generation_cost"] = self._calculate_request_cost(
                OpenRouterModel.GEMINI_FLASH, response.get("usage", {})
            )
            ...
            try:
                ...
                story_data["generation_cost"] = self._calculate_request_cost(
                    OpenRouterModel.CLAUDE_HAIKU, response.get("usage", {})
                )
        ...
        try:
            response = await self._make_api_request(
                ...
                messages=[
                    {
                        "role": "user",
                        "content": "Say 'Hello, OpenRouter!' and nothing else.",
                    }
                ],
                max_tokens=10,
                timeout=10,
            ...
            return {
                ...
                "cost": self._calculate_request_cost(
                    OpenRouterModel.GEMINI_FLASH, response.get("usage", {})
                ),
            }
