...
def generate_scene_collection(
    ...
    if "content" in story_chapter:
        ...
        images.append({"type": "main_scene", "sequence": 1, **main_scene})
...
def _enhance_prompt(
    description: str, style: str, mood: str, context: Optional[Dict] = None
) -> str:
...
def _get_generation_params(style: str, provider: str) -> Dict:
    ...
    base_params = {"steps": 30, "cfg_scale": 7.5, "sampler": "DPM++ 2M Karras"}

    provider_params = {
        "stability_ai": {
            "model": "stable-diffusion-xl-1024-v1-0",
            "style_preset": style
            if style in ["photographic", "digital-art", "comic-book"]
            else None,
        },
        "getimg_ai": {"model": "stable-diffusion-xl-v1-0", "scheduler": "euler_a"},
        "replicate": {
            "model": "stability-ai/stable-diffusion",
            "num_inference_steps": 50,
        },
        "stablediffusion_api": {"model_id": "sd-xl-base-1.0", "enhance_prompt": "yes"},
    }
