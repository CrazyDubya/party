...
class TestStoryQualityChecker:
            ...
            "chapters": [
                {
                    ...
                    "choices": [
                        {
                            "id": "a",
                            "text": "Hide behind the oak tree and observe the newcomers",
                            "leads_to": 2,
                        },
                        {
                            "id": "b",
                            "text": "Step forward and greet the approaching voices",
                            "leads_to": 3,
                        },
                        {
                            "id": "c",
                            "text": "Touch the glowing symbols first, then decide",
                            "leads_to": 4,
                        },
                    ],
                },
                {
                    ...
                    "choices": [
                        {
                            "id": "a",
                            "text": "Continue listening to learn more about the prophecy",
                            "leads_to": 5,
                        },
                        {
                            "id": "b",
                            "text": "Reveal yourself and ask about being the chosen one",
                            "leads_to": 6,
                        },
                    ],
                },
            ...
            "chapters": [
                {
                    ...
                    "choices": [{"id": "a", "text": "Go home", "leads_to": 2}],
                }
            ],
        }
    ...
    def test_check_story_quality_no_chapters(self, checker):
        ...
        assert any(
            issue["type"] == QualityIssue.POOR_STRUCTURE.value
    ...
    def test_check_story_quality_short_story(self, checker, short_story):
        ...
        assert any(
            issue["type"] == QualityIssue.WORD_COUNT.value for issue in result.issues
        )
    ...
    def test_check_story_quality_long_story(self, checker, valid_story):
        ...
        long_text = (
            valid_story["chapters"][0]["text"] * 10
        )  # Repeat text to make it long
        ...
        word_count_issues = [
            issue
            for issue in result.issues
            if issue["type"] == QualityIssue.WORD_COUNT.value
        ]
    ...
    def test_check_story_quality_ai_language(self, checker, ai_language_story):
        ...
        ai_issues = [
            issue
            for issue in result.issues
            if issue["type"] == QualityIssue.AI_LANGUAGE.value
        ]
    ...
    def test_check_story_quality_generic_content(self, checker, generic_story):
        ...
        generic_issues = [
            issue
            for issue in result.issues
            if issue["type"] == QualityIssue.CLICHE_OVERUSE.value
        ]
    ...
    def test_count_total_words_no_text(self, checker):
        ...
        story = {
            "chapters": [{"id": 1, "choices": []}, {"id": 2, "text": "", "choices": []}]
        }
    ...
    def test_check_choices_sufficient(self, checker, valid_story):
        ...
        choice_issues = [
            issue
            for issue in issues
            if issue["type"] == QualityIssue.INSUFFICIENT_CHOICES.value
        ]
    ...
    def test_check_choices_short_choice_text(self, checker):
        ...
        structure_issues = [
            issue
            for issue in issues
            if issue["type"] == QualityIssue.POOR_STRUCTURE.value
        ]
    ...
    def test_detect_ai_language_not_found(self, checker, valid_story):
        ...
        ai_issues = [
            issue for issue in issues if issue["type"] == QualityIssue.AI_LANGUAGE.value
        ]
        assert len(ai_issues) == 0
    ...
    def test_check_narrative_consistency_with_characters(self, checker, valid_story):
        ...
        consistency_issues = [
            issue
            for issue in issues
            if issue["type"] == QualityIssue.INCONSISTENT_NARRATIVE.value
        ]
    ...
    def test_calculate_human_likeness_repetitive_structure(self, checker):
        ...
        story = {
            "chapters": [
                {
                    "id": 1,
                    "text": "Chapter one begins with this exact same text",
                    "choices": [],
                },
                {
                    "id": 2,
...
class TestConvenienceFunctions:
    ...
    def test_check_story_function(self, valid_story):
        ...
        with patch(
            "app.ai.quality_checker.quality_checker.check_story_quality"
        ) as mock_check:
...
class TestQualityScoring:
    ...
    def test_word_count_precision(self, precision_checker):
        ...
        for text, expected_count in test_cases:
            ...
            ), f"Failed for text: '{text}' - expected {expected_count}, got {actual_count}"
    ...
    def test_generic_phrase_case_insensitivity(self, precision_checker):
        ...
        assert any(
            "it was a dark and stormy night" in cliche
            for cliche in issues[0]["cliches"]
        )
...
class TestRealWorldScenarios:
    ...
    def test_high_quality_story_scenario(self, production_checker):
            ...
            "chapters": [
                {
                    ...
                    "choices": [
                        {
                            "id": "a",
                            "text": "Light the beacon to warn the ship away from the approaching danger",
                            "leads_to": 2,
                        },
                        {
                            "id": "b",
                            "text": "Rush down to radio the coast guard about the strange phenomena",
                            "leads_to": 3,
                        },
                        {
                            "id": "c",
                            "text": "Consult grandfather's journal for clues about the sea creatures",
                            "leads_to": 4,
                        },
                    ],
                }
        ...
        )  # Adjusted for test story length (actual: 139 words)
        assert (
            ...
            "chapters": [
                {
                    ...
                    "choices": [
                        {
                            "id": "a",
                            "text": "Go toward the glowing object",
                            "leads_to": 2,
                        },
                        {
                            "id": "b",
                            "text": "Turn back and leave the forest",
                            "leads_to": 3,
                        },
                    ],
                }
    ...
    def test_failed_story_multiple_issues(self, production_checker):
            ...
            "chapters": [
                {
                    ...
                    "choices": [{"id": "a", "text": "Go", "leads_to": 2}],  # Too short
                }
            ],
        }
        ...
        assert (
            QualityIssue.INSUFFICIENT_CHOICES.value in issue_types
            or QualityIssue.POOR_STRUCTURE.value in issue_types
        )
    ...
    def test_story_with_good_dialogue_and_detail(self, production_checker):
            ...
            "chapters": [
                {
                    ...
                    "choices": [
                        {
                            "id": "a",
                            "text": "Ask about the price and negotiate if necessary",
                            "leads_to": 2,
                        },
                        {
                            "id": "b",
                            "text": "Inquire about the necklace's history and origin",
                            "leads_to": 3,
                        },
                        {
                            "id": "c",
                            "text": "Thank him politely but look at other stalls first",
                            "leads_to": 4,
                        },
                    ],
                }
        ...
        assert (
            result.human_likeness_score >= 75
        )  # Should score high for dialogue and sensory details
        ...
        assert any(
            word in text.lower() for word in ["scent", "shadows", "smooth", "gleaming"]
        )  # Sensory details
            ...
            "chapters": [
                {
                    ...
                    "choices": [
                        {
                            "id": "a",
                            "text": "Examine the threatening letter more closely with Torres",
                            "leads_to": 2,
                        },
                        {
                            "id": "b",
                            "text": "Focus on the scattered research papers and chemical formulas",
                            "leads_to": 3,
                        },
                        {
                            "id": "c",
                            "text": "Check the security system and look for any footage",
                            "leads_to": 4,
                        },
                    ],
                }
