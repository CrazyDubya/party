...
class StableDiffusionClient:
    ...
    async def _generate_runware(
        self, prompt: str, size: ImageSize, model: ImageModel, settings: ImageSettings
    ) -> Dict:
    ...
    def get_usage_stats(self) -> Dict:
        ...
        provider_stats = {
            provider.value: count for provider, count in self.provider_usage.items()
        }
        ...
        return {
            ...
            "estimated_capacity": int(10.0 / avg_cost_per_request)
...
async def generate_story_image(
    ...
    enhanced_prompt = (
        f"{prompt}, {style}, highly detailed, cinematic lighting, beautiful composition"
    )
