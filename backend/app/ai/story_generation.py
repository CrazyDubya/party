...
def generate_story(
    premise: str, mood: str = "neutral", characters: int = 3, chapters: int = 3
) -> Dict:
    """
    ...
    story_templates = {
        "cyberpunk": {
            ...
            "characters": [
                {
                    "name": "Zara",
                    "role": "Street-smart hacker",
                    "description": "Augmented eyes gleaming with data streams",
                },
                {
                    "name": "Marcus",
                    "role": "Ex-corporate enforcer",
                    "description": "Scarred hands tell stories of violent betrayals",
                },
                {
                    "name": "Echo",
                    "role": "Mysterious AI fragment",
                    "description": "Speaks in riddles through stolen corpo-screens",
                },
            ],
        },
        "fantasy": {
            ...
            "characters": [
                {
                    "name": "Lyanna",
                    "role": "Reluctant forest guardian",
                    "description": "Green eyes that see through illusions",
                },
                {
                    "name": "Thorne",
                    "role": "Banished court wizard",
                    "description": "Hands that remember forgotten spells",
                },
                {
                    "name": "Whisper",
                    "role": "Shape-shifting familiar",
                    "description": "Never quite the same creature twice",
                },
            ],
        },
        "detective": {
            ...
            "characters": [
                {
                    "name": "Detective Ray Sullivan",
                    "role": "Weathered investigator",
                    "description": "Whiskey breath and tired eyes that miss nothing",
                },
                {
                    "name": "Victoria Chen",
                    "role": "Mysterious client",
                    "description": "Red lips hiding dangerous truths",
                },
                {
                    "name": "Eddie 'The Knife' Torrino",
                    "role": "Small-time crook",
                    "description": "Knows everyone's business but his own",
                },
            ],
        },
    }
...
MOCK_API_CONFIG = {
    ...
    "generation_params": {"max_tokens": 2000, "temperature": 0.7, "top_p": 0.9},
}
